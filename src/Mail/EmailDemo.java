...
public class EmailDemo
{
    public static void main(String[] args) {
        ...
        String  d_email = "",
                d_uname = "Name",
                d_password = "",//"AIzaSyCeh2KTi99bSAyOaHu-TzZ9t0ChVHwjOUk",//"",
        ...
        try {
            ...
            msg.addRecipients(Message.RecipientType.TO, new InternetAddress[]{new InternetAddress(""), new InternetAddress(m_to)});//, new InternetAddress("shiwuzhu@amazon.com")});
            //msg.setText(m_text);
