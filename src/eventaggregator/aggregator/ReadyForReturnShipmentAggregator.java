 ...
 */
@Component
public class ReadyForReturnShipmentAggregator extends AbstractShipmentAggregator<PSREvent, PSRShipmentEvent> {
...
//    {
//        return ShipmentOperation.ShipmentOperationTarget.ReadyForReturn;
//    }
}
